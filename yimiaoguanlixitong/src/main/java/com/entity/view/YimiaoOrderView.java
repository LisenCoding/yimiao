...
public class YimiaoOrderView extends YimiaoOrderEntity implements Serializable {
	...
	* 接种地点的值
	*/
	@ColumnInfo(comment="接种地点的字典表值",type="varchar(200)")
	private String yimiaoDidianValue;
	...
	* 获取： 接种地点的值
	*/
	public String getYimiaoDidianValue() {
		return yimiaoDidianValue;
	}
	/**
	* 设置： 接种地点的值
	*/
	public void setYimiaoDidianValue(String yimiaoDidianValue) {
		this.yimiaoDidianValue = yimiaoDidianValue;
	}
	...
	public String toString() {
		return "YimiaoOrderView{" +
			...
			", yimiaoDidianValue=" + yimiaoDidianValue +
