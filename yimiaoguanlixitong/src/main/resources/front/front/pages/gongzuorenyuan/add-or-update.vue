    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#f5f5f5","textAlign":"left"}'
                      class="title">工作人员姓名</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"#f5f5f5","backgroundColor":"#fff","color":"rgba(161, 161, 161, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"3rpx","fontSize":"28rpx","borderStyle":"dashed ","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.gongzuorenyuanName" type="text" v-model="ruleForm.gongzuorenyuanName" placeholder="工作人员姓名"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#f5f5f5","textAlign":"left"}'
                      class="title">工作人员手机号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"#f5f5f5","backgroundColor":"#fff","color":"rgba(161, 161, 161, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"3rpx","fontSize":"28rpx","borderStyle":"dashed ","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.gongzuorenyuanPhone" type="text" v-model="ruleForm.gongzuorenyuanPhone" placeholder="工作人员手机号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#f5f5f5","textAlign":"left"}'
                      class="title">工作人员身份证号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"#f5f5f5","backgroundColor":"#fff","color":"rgba(161, 161, 161, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"3rpx","fontSize":"28rpx","borderStyle":"dashed ","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.gongzuorenyuanIdNumber" type="text" v-model="ruleForm.gongzuorenyuanIdNumber" placeholder="工作人员身份证号"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="gongzuorenyuanPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#f5f5f5","textAlign":"left"}'
                          class="title">工作人员头像</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.gongzuorenyuanPhoto" :src="baseUrl+ruleForm.gongzuorenyuanPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#f5f5f5","textAlign":"left"}'
                      class="title">工作人员邮箱</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"#f5f5f5","backgroundColor":"#fff","color":"rgba(161, 161, 161, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"3rpx","fontSize":"28rpx","borderStyle":"dashed ","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.gongzuorenyuanEmail" type="text" v-model="ruleForm.gongzuorenyuanEmail" placeholder="工作人员邮箱"></input>
            </view>
    ...
    export default {
		...
		/*下拉框*/
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`gongzuorenyuan`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.gongzuorenyuanId){
                this.ruleForm.gongzuorenyuanId = options.gongzuorenyuanId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.gongzuorenyuanName)) {
                    this.$utils.msg(`工作人员姓名不能为空`);
                    return
                }
				if ((!this.ruleForm.gongzuorenyuanPhone) && (!this.$validate.isMobile(this.ruleForm.gongzuorenyuanPhone))) {
                    this.$utils.msg(`工作人员手机号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.gongzuorenyuanIdNumber) && (!this.$validate.checkIdCard(this.ruleForm.gongzuorenyuanIdNumber))) {
                    this.$utils.msg(`工作人员身份证号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.gongzuorenyuanPhoto)) {
                    this.$utils.msg(`工作人员头像不能为空`);
                    return
                }
				...
				if ((!this.ruleForm.gongzuorenyuanEmail) && (!this.$validate.isEmail(this.ruleForm.gongzuorenyuanEmail))) {
                    this.$utils.msg(`工作人员邮箱不能为空并且需要输入正确格式`);
                    return
                }
                if (this.ruleForm.id) {
                    await this.$api.update(`gongzuorenyuan`, this.ruleForm);
                } else {
                    await this.$api.save(`gongzuorenyuan`, this.ruleForm);
                }
