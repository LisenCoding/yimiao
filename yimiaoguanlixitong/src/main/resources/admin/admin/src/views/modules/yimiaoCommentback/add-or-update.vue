        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='yimiao'">
                    <el-form-item class="select" v-if="type!='info'"  label="疫苗" prop="yimiaoId">
                        <el-select v-model="ruleForm.yimiaoId" :disabled="ro.yimiaoId" filterable placeholder="请选择疫苗" @change="yimiaoChange">
                            <el-option
