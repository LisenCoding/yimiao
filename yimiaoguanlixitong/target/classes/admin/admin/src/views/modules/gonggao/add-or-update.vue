        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.gonggaoContent = _this.ruleForm.gonggaoContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.gonggaoContent = this.ruleForm.gonggaoContent.replaceAll(this.$base.url,"");
                        this.$http({
